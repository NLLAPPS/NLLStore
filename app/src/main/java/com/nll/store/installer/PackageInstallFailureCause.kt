 ...
 */
sealed class PackageInstallFailureCause(open val message: String?) {
     ...
     */
    data class Generic(override val message: String?) : PackageInstallFailureCause(message) {
        override fun toString(): String = message ?: "INSTALL_FAILURE"
    }
     ...
     */
    data class Aborted(override val message: String?) : PackageInstallFailureCause(message) {
        override fun toString(): String = message ?: "INSTALL_FAILURE_ABORTED"
    }
    ...
    ) : PackageInstallFailureCause(message) {

        override fun toString(): String = (message ?: "INSTALL_FAILURE_BLOCKED") +
    ...
    data class Conflict(
        ...
        override fun toString(): String = "${message ?: "INSTALL_FAILURE_CONFLICT"}${if (otherPackageName != null) " | OTHER_PACKAGE_NAME = $otherPackageName" else ""}"
    }
     ...
     */
    data class Incompatible(override val message: String?) : PackageInstallFailureCause(message) {
        override fun toString(): String = message ?: "INSTALL_FAILURE_INCOMPATIBLE"
    }
     ...
     */
    data class Invalid(override val message: String?) : PackageInstallFailureCause(message) {
        override fun toString(): String = message ?: "INSTALL_FAILURE_INVALID"
    }
    ...
    data class Storage(
        ...
        override fun toString(): String = "${message ?: "INSTALL_FAILURE_STORAGE"}${if (storagePath != null) " | STORAGE_PATH = $storagePath" else ""}"
    }
}