...
import com.nll.store.databinding.UninstallActivityBinding
import com.nll.store.utils.getInstalledApplicationsCompat
import com.nll.store.viewmodels.UninstallViewModel
...
class UninstallActivity : AppCompatActivity() {
	...
	private fun getInstalledAppsList() = packageManager.getInstalledApplicationsCompat(0)
