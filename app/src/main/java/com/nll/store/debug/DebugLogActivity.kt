...
import com.nll.store.App
import com.nll.store.R
import com.nll.store.databinding.ActivityDebugLogBinding
...
class DebugLogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DebugLogService.serviceMessage().onEach { serviceMessage ->
            android.util.Log.d("STORE_$logTag", "serviceMessage -> $serviceMessage")
                ...
                is DebugLogServiceMessage.Saved -> {
                    if (serviceMessage.success) {
                        ...
                        val i = Intent(Intent.ACTION_SEND).apply {
                            ...
                            putExtra(Intent.EXTRA_EMAIL, arrayOf(App.contactEmail))
                        ...
                        try {
                            ...
                            Toast.makeText(this, R.string.no_url_handle, Toast.LENGTH_SHORT).show()
                        }
                    } else {
