...
public class DebugLogAttachmentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.nll.store.debug.DebugLogAttachmentProvider";
    ...
    public static Uri getAttachmentUri(boolean useFileUri, File file) {
        ...
        if (CLog.isDebug()) {
            CLog.log(TAG, "Attachment URI is: " + uri);
        }
        return uri;
    ...
    public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
        if (CLog.isDebug()) {
            CLog.log(TAG, "Called with uri: " + uri);
        }
        ...
        switch (uriMatcher.match(uri)) {
            case cache_code:
                if (CLog.isDebug()) {
                    CLog.log(TAG, "File to open is : " + uri.getLastPathSegment());}
            ...
            default:
                if (CLog.isDebug()) {
                    CLog.log(TAG, "Unsupported uri: '" + uri);
                }
    ...
    private File getLogFileUri(Uri uri) {
        ...
        if (CLog.isDebug()) {
            CLog.log(TAG, "getLogFileUri " + file.getAbsolutePath());
        }
        return file;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if (CLog.isDebug()) {
            CLog.log(TAG, "query file is " + file.getAbsolutePath());
        }
        if (projection == null) {
